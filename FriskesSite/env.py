...
WINDOWS_REDIS_INSTALLED = bool(int(os.environ.get('WINDOWS_REDIS_INSTALLED')))
RUN_DEV_SERVER_WITH_DOCKER = bool(int(os.environ.get('RUN_DEV_SERVER_WITH_DOCKER')))
...
CELERY_FLOWER_URL_PREFIX = os.environ.get('CELERY_FLOWER_URL_PREFIX')
CELERY_FLOWER_ADDRESS = os.environ.get('CELERY_FLOWER_ADDRESS') if RUN_DEV_SERVER_WITH_DOCKER else '127.0.0.1'
CELERY_FLOWER_PORT = os.environ.get('CELERY_FLOWER_PORT')
