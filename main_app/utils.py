...
class DataMixin:
    ...
    def get_context_data(self, *, object_list=None, **kwargs):
        ...
        Так же при первом входе на сайт в рамках одной сессии, запрашиваем
        у twitch API актуальный список онлайн стримеров для подсчёта их количества,
        записи в сессию и передачи в контекст, при дальнейших вызовах в рамках одной сессии
        значение будет браться из сессии без вызова twitch API."""
